...
export default interface IFloorService {
  createFloor(floorDTO: IFloorDTO, classroomIds: string[]): Promise<Result<IFloorDTO>>;
  updateFloor(floorDTO: IFloorDTO, classroomIds: string[]): Promise<Result<IFloorDTO>>;
